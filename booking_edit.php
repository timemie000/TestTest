<?php
    ...
    $sql2="select * from rooms,bookings_table where rooms.id=bookings_table.room_id and bookings_table.id='$id_book'";
...
?>
    <br/><br/><br/>
    <form name="form1" method="post" action="booking_edit2.php" enctype="multipart/form-data">
